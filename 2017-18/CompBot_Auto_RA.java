...
@Autonomous(name = "CompBot Auto Red-Audience", group = "Linear Opmode")
//@Disabled

public class CompBot_Auto_RA extends LinearOpMode{ //Autonomous Program for Red-Audience balancing stone
        ...
        while(opModeIsActive()) {
            ...
            switch(step) {
                ...
                case 2: rightKnock.setPosition(Servo.MAX_POSITION); //hopefully this is down.
                    double power = 0;
                    if(Functions.checkColor(rightSensor, "RED"))
                        power = 0.5;
                    else
                        power = -0.5;
                    t.reset();
